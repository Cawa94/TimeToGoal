...
struct ProfileChallenge: Identifiable {
    ...
    static var allValues: [ProfileChallenge] = [
        ...
        .init(id: 13, name: "challenge_fifteenth_name", image: "017-gold medal", goalToReach: 50),
        .init(id: 14, name: "challenge_sixteenth_name", image: "018-silver medal", goalToReach: 20)//,
