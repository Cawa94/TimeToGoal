...
extension Color {
    ...
    static let pageBackground = Color.grayBackground
    static let pageLightBackground = Color.grayLightBackground
...
extension UIColor {
    ...
    static let pageBackground = UIColor.grayBackground
    static let pageLightBackground = UIColor.grayLightBackground
...
extension UIColor {
    ...
    static let grayLightBackground  = UIColor.named("grayLightBackground")
